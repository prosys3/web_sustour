...
<div class="list-group">
    ...
    <a href="activities_list.php?dashboard=3" class="list-group-item ' . activeItem(3) . '"><i class="material-icons">description</i> Activities <span class="'.activeBadge(3).'">' . counter("activities") . '</span></a>
