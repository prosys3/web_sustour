...
<div class="list-group">
    ...
    <a href="user_list.php?dashboard=3" class="list-group-item ' . activeItem(3) . '"><i class="material-icons">person</i> Users <span class="'.activeBadge(3).'">' . counter("users") . '</span></a>
    <a href="file_list.php?dashboard=4" class="list-group-item ' . activeItem(4) . '"><i class="material-icons">folder</i> Files <span class="'.activeBadge(4).'">' . counter("files") . '</span></a>
</div>
